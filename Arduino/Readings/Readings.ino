...
//const char* ssid= "Meeran";
//const char* password= "Miran14777";

String data = "";
String saved_networks[] = {"STUDBME1", "STUDBME2", "iot", "ARC3","adel", "CMP_LAB4", "CMP_LAB2", "CMP_LAB1"}; 
...
int postValues(String json) {
  ...
  http.begin(ourClient,"http://172.28.130.54:8000/post"); //Specify request destination
